...
#[must_use]
pub fn default_cache_profiles() -> Vec<CacheProfileRule> {
    use CacheTtl::{FiveMinutes, ThirtyMinutes};

    vec![
        CacheProfileRule {
            provider_key_contains: Some("bedrock".to_string()),
            upstream_model_contains: Some("gpt-5.6".to_string()),
            minimum_cacheable_tokens: 1_024,
            default_ttl: ThirtyMinutes,
        },
        CacheProfileRule {
            provider_key_contains: Some("bedrock".to_string()),
            upstream_model_contains: Some("claude-sonnet-4-5".to_string()),
            minimum_cacheable_tokens: 4_096,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: Some("bedrock".to_string()),
            upstream_model_contains: Some("claude-haiku-4-5".to_string()),
            minimum_cacheable_tokens: 4_096,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: Some("bedrock".to_string()),
            upstream_model_contains: Some("claude-opus-4-5".to_string()),
            minimum_cacheable_tokens: 4_096,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: Some("bedrock".to_string()),
            upstream_model_contains: Some("claude-opus-4-6".to_string()),
            minimum_cacheable_tokens: 4_096,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: None,
            upstream_model_contains: Some("claude-opus-5".to_string()),
            minimum_cacheable_tokens: 512,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: None,
            upstream_model_contains: Some("claude-opus-4-7".to_string()),
            minimum_cacheable_tokens: 2_048,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
            provider_key_contains: None,
        ...
        CacheProfileRule {
            provider_key_contains: None,
            upstream_model_contains: Some("claude-sonnet".to_string()),
            minimum_cacheable_tokens: 1_024,
            default_ttl: FiveMinutes,
        },
        CacheProfileRule {
