...
type BrandIconSource = { kind: 'image' | 'mask'; src: string } | { kind: 'svg'; path: string }
...
const TYPESAFE_ICON_PATH =
  'M12 2l2.1 6.5H21l-5.5 4.1 2.1 6.4L12 14.9 6.4 19l2.1-6.4L3 8.5h6.9L12 2z'
...
const BRAND_ICON_SOURCES: Record<BrandIconKey, BrandIconSource> = {
  ...
  deepseek: { kind: 'image', src: deepSeekIcon },
  gemini: { kind: 'image', src: geminiIcon },
  openai: { kind: 'svg', path: OPENAI_ICON_PATH },
  openrouter: { kind: 'svg', path: OPENROUTER_ICON_PATH },
  qwen: { kind: 'image', src: qwenIcon },
  typesafe: { kind: 'svg', path: TYPESAFE_ICON_PATH },
