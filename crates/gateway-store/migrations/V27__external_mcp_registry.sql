CREATE TABLE IF NOT EXISTS external_mcp_servers (
  ...
  last_successful_discovery_at INTEGER,
  last_error_summary TEXT,
  last_tool_count INTEGER CHECK (last_tool_count IS NULL OR last_tool_count >= 0),
...
CREATE TABLE IF NOT EXISTS external_mcp_discovery_runs (
  ...
  discovered_tool_count INTEGER NOT NULL DEFAULT 0 CHECK (discovered_tool_count >= 0),
  active_tool_count INTEGER NOT NULL DEFAULT 0 CHECK (active_tool_count >= 0),
