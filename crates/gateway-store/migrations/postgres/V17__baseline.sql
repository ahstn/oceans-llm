...
CREATE TABLE IF NOT EXISTS model_pricing (
  ...
  input_cost_per_million_tokens_10000 BIGINT,
  output_cost_per_million_tokens_10000 BIGINT,
  cache_read_cost_per_million_tokens_10000 BIGINT,
  cache_write_cost_per_million_tokens_10000 BIGINT,
  input_audio_cost_per_million_tokens_10000 BIGINT,
  output_audio_cost_per_million_tokens_10000 BIGINT,
  release_date TEXT NOT NULL,
  last_updated TEXT NOT NULL,
  effective_start_at BIGINT NOT NULL,
  effective_end_at BIGINT,
  limits_json TEXT NOT NULL DEFAULT '{}',
  modalities_json TEXT NOT NULL DEFAULT '{}',
  provenance_source TEXT NOT NULL,
  provenance_etag TEXT,
  provenance_fetched_at BIGINT NOT NULL,
  created_at BIGINT NOT NULL,
  updated_at BIGINT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS request_logs (
  ...
  request_payload_truncated BIGINT NOT NULL DEFAULT 0 CHECK (request_payload_truncated IN (0, 1)),
  response_payload_truncated BIGINT NOT NULL DEFAULT 0 CHECK (response_payload_truncated IN (0, 1)),
  caller_service TEXT,
...
CREATE TABLE IF NOT EXISTS usage_cost_event_duplicates_archive (
  ...
  team_id TEXT,
  model_id TEXT,
  original_estimated_cost_10000 BIGINT NOT NULL CHECK (original_estimated_cost_10000 >= 0),
  occurred_at BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS usage_cost_events (
  ...
  pricing_source_fetched_at BIGINT,
  pricing_last_updated TEXT,
  input_cost_per_million_tokens_10000 BIGINT,
  output_cost_per_million_tokens_10000 BIGINT,
  computed_cost_10000 BIGINT NOT NULL CHECK (computed_cost_10000 >= 0),
  occurred_at BIGINT NOT NULL,
  FOREIGN KEY (api_key_id) REFERENCES api_keys(id) ON DELETE CASCADE,
  FOREIGN KEY (user_id) REFERENCES users(user_id) ON DELETE SET NULL,
  FOREIGN KEY (team_id) REFERENCES teams(team_id) ON DELETE SET NULL,
