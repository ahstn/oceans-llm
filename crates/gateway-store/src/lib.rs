...
mod tests {
    ...
    use gateway_core::{
        ...
        RequestLogRecord, RequestLogRepository, SYSTEM_LEGACY_TEAM_ID, SYSTEM_LEGACY_TEAM_KEY,
        SeedApiKey, SeedModel, SeedModelRoute, SeedProvider, StoreHealth,
    };
    ...
    async fn libsql_request_log_migration_backfills_resolved_model_key() {
        ...
        apply_libsql_migrations_through(&db_path, 8)
            .await
            .expect("migrations through v8");
    ...
    async fn postgres_request_log_migration_backfills_resolved_model_key() {
        ...
        apply_postgres_migrations_through(&test_db.database_url, 8)
            .await
            .expect("migrations through v8");
