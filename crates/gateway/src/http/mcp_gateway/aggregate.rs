...
use execution::call_catalog_tool;
...
use gateway_service::{
    CallMcpToolInput, DescribeMcpToolInput, MAX_SEARCH_LIMIT, McpCatalog, SearchMcpToolsInput,
};
...
use super::{
    ...
    extract_mcp_gateway_api_key, guardrail_decision_metadata, mcp_error_response,
};
