...
- Docs site workflows: `mise run //docs:install`, `mise run //docs:dev`, `mise run //docs:build`
...
| [.github/workflows/docs-ci.yml](.github/workflows/docs-ci.yml) | VitePress static-site build via `mise run //docs:build` |
