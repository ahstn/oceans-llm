...
Treat [../pricing-catalog-and-accounting.md](../configuration/pricing-catalog-and-accounting.md) and [../budgets-and-spending.md](../contributing/operations/budgets-and-spending.md) as the canonical current-state docs.
