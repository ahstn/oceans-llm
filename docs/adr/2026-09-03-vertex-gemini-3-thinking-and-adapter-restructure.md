...
7. Derive `api_host` from `location` when unset (`global`, `us`/`eu` multi-region, regional), and batch text-embedding `predict` calls at 250 instances.
