...
- Shadow task diagnostics are platform-admin only.
- Team Owners/Admins receive task access only when both calibrated-score and team-admin capabilities are enabled.
